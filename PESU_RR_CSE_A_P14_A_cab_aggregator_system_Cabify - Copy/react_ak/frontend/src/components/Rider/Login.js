// src/components/Rider/Login.js
import React, { useState, useEffect } from "react";
import { riderAPI } from "../../api/api";
import { setRiderToken, getRiderToken } from "../../utils/authHelper";
...
export default function RiderLogin() {
  ...
  useEffect(() => {
    if (getRiderToken()) nav("/dashboard");
  }, [nav]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-white to-olaGray">
